  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="font-mono text-[8px] sm:text-[10px] uppercase tracking-[0.2em] truncate px-2"
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 p-3 sm:p-5">
        {/* Sidebar - horizontal scroll on mobile */}
        <aside className="lg:col-span-3 overflow-x-auto pb-2 lg:pb-0">
          <div className="flex lg:flex-col gap-0.5 min-w-max lg:min-w-0">
            {[
              "Overview",
              "Loss Prevention",
              "Inventory",
              ...
              <div
                key={s}
                className="flex items-center justify-between rounded-md px-2 sm:px-2.5 py-1.5 text-[11px] whitespace-nowrap"
                style={{
              ...
              >
                ...
                {i === 1 && (
                  <span
                    className="rounded-sm px-1.5 py-0.5 font-mono text-[9px] ml-2"
        ...
        <div className="lg:col-span-9 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              >
                ...
                <div
                  className="mt-1.5 text-[14px] sm:text-[16px] font-medium tracking-tight"
          ...
          >
            <div className="mb-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <div className="flex gap-1">
                {["1D", "7D", "30D", "QTD"].map((t, i) => (
                  <span
                    key={t}
                    className="rounded px-2 py-0.5 font-mono text-[9px] cursor-pointer transition-all"
                    style={{
            ...
            <div className="w-full overflow-x-auto">
              <svg
                viewBox="0 0 600 140"
                className="h-28 sm:h-32 w-full min-w-[300px]"
              >
                <defs>
          ...
          {/* Anomaly table - horizontal scroll on mobile */}
          <div
          ...
          >
            <div className="min-w-[500px]">
              {/* Table header */}
              <div
                className="grid grid-cols-5 gap-2 sm:gap-3 px-3 sm:px-4 py-2 font-mono text-[9px] uppercase tracking-wider"
                style={{
              ...
              {[
                ...
                <div
                  key={i}
                  className="grid grid-cols-5 gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-2.5 text-[11px]"
                  style={{
                ...
                >
                  ...
                  <div className="text-[10px] sm:text-[11px]">{r[1]}</div>
                  <div>
                    <span
                      className="rounded-sm px-1.5 py-0.5 font-mono text-[9px] whitespace-nowrap"
                      style={
                        r[5] === "high"
                          ? {
                  ...
                  <div
                    className="text-right font-mono text-[9px] sm:text-[10px]"
                    style={{
