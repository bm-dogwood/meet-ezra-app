          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <div className="space-y-8 text-surface-300">
              <section>
                ...
                <p>
                  Ezra AI ("we," "our," or "us") is committed to protecting your
                  privacy. This Privacy Policy explains how we collect, use,
                  disclose, and safeguard your information when you use our
                  platform and services.
                </p>
                <p className="mt-4">
                  By accessing or using Ezra, you agree to the terms of this
              ...
              <section>
                ...
                <h3 className="text-xl font-medium text-white mt-6 mb-3">
                  2.2 POS and Business Data
                </h3>
                <p>
                  When you connect your POS system to Ezra, we collect
                  transactional and operational data including but not limited
                  to:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-3">
                  <li>Sales transactions and revenue data</li>
                  <li>
                    Payment method information (aggregated, not individual card
                    numbers)
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4 mt-3">
                  ...
                  <li>
                    Generate analytics, reports, and insights for your business
                  </li>
              ...
              <section>
                ...
                <p>
                  Data is shared among authorized users within your organization
                  based on role-based access controls that you configure.
                </p>
                ...
                <p>
                  ...
                  services on our behalf, such as cloud hosting, analytics, and
                  customer support. These providers are contractually obligated
                ...
                <p>
                  ...
                  rights, property, or safety of Ezra, our users, or others.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-4">
                  Upon account termination, you may request deletion of your
                  data. Certain data may be retained for legal or legitimate
                  business purposes.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  and track information about your activity on our platform. You
              ...
              <section>
                ...
                <p>
                  ...
                  children. If we learn we have collected personal information
